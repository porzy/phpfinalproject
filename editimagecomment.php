...
$query = "SELECT * FROM image_comment WHERE imagecommentid = :id";
...
<body>
  <div id="wrapper">
      ...
      <div id="all_blogs">
        <form action="imagecomments.php" method="post">
          <fieldset>
            <legend>Edit image comment</legend>
            
            <p>
              <label for="comment">comment</label>
              <textarea name="comment" id="comment"><?= $post['Comment'] ?></textarea>
            </p>
            <p>
              <input type="hidden" name="id" value=<?= $post['ImageCommentId'] ?> />
